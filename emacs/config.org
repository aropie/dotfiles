...
#+BEGIN_SRC emacs-lisp
  ...
  ;; fake-keyword is needed because of the way the macro is defined
  ;; https://github.com/noctuid/general.el#positional-argument-wrappers
  (my-leader
    :fake-keyword t
...
#+BEGIN_SRC emacs-lisp
  (my-leader
    ...
    "B" '(general-describe-keybindings :which-key "Personal bindings")
...
#+BEGIN_SRC emacs-lisp
  (use-package multi-vterm
    ...
    :general ("C-<return>" 'multi-vterm-dedicated-toggle)
    :config
    ;; (general-define-key
    ;;  "C-<return>" 'multi-vterm-dedicated-toggle)
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package lsp-ui
    ...
    (my-leader
  	:infix aropie/toggle-prefix
  	"b" '(lsp-headerline-breadcrumb-mode :which-key "Breadcrumb"))
    (general-define-key
...
#+BEGIN_SRC emacs-lisp
  (my-leader
    ...
    "m" '(magit-dispatch :which-key "Menu")
