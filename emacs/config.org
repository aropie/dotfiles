...
Whenever creating a new file, we want to create as much parent directories as needed.
Taken from [[https://newbedev.com/can-i-create-directories-that-don-t-exist-while-creating-a-new-file-in-emacs][here]]
#+BEGIN_SRC emacs-lisp
