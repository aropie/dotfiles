...
#+BEGIN_SRC emacs-lisp
  (use-package multi-vterm
    ...
    :general ("C-<return>" 'aropie/toggle-switch-dedicated-vterm)
    :init
  ...
  If it's visible and selected, close it."
    ...
    (defun aropie/toggle-switch-dedicated-vterm (arg)
  	(interactive "P")
  	(if arg  ;; Called with C-u
  		(aropie/switch-dedicated-vterm)
  	  (aropie/dwim-toggle-dedicated-vterm)))
    :config
